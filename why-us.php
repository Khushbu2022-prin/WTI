                    ...
                    <div class="about__right">
                        ...
                        <div class="about__icon-box">
                            ...
                            <div class="about__icon-text">
                                <p>WTI Primes is dedicated to providing excellence and transparency through our fully regulated brokerage service to our international clients with some of the most competitive spreads in the industry, and first-class professional support 24/5.</p>
                            </div>
                        </div>
  ...
  <section class="real-world">
            ...
            <div class="container">
                <div class="section-title text-center">
                    ...
                    <span class="section-title__tagline">Choosing the right broker is critical for every trader’s success. We offer a unique combination of time-tested technical exellence, exceptional customer support and security of investor funds.</span>
                </div>
                <div class="row">
                    <div class="col-xl-4 col-lg-4 wow fadeInUp animated" data-wow-delay="0ms" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 0ms; animation-name: fadeInUp;">
                        ...
                        <div class="real-world__single">
                            <h2 class="real-world__title"><a>24/5 Live  <br> Customer Support</a>
                            </h2>
                            <a class="real-world__btn">Read More</a>
                    ...
                    <div class="col-xl-4 col-lg-4 wow fadeInUp animated" data-wow-delay="300ms" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 300ms; animation-name: fadeInUp;">
                        <!--Real World Single-->
                        <div class="real-world__single">
                            <h2 class="real-world__title"><a>200+ Instruments  <br> to Trade</a></h2>
                            <a class="real-world__btn">Read More</a>
                            <div class="real-world__icon-box">
                                <span class="icon-data-analytics"></span>
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-4 wow fadeInUp animated" data-wow-delay="600ms" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 600ms; animation-name: fadeInUp;">
                        <!--Real World Single-->
                        <div class="real-world__single">
                            <h2 class="real-world__title"><a >Fast Order  <br> Execution</a>
                            </h2>
                            <a  class="real-world__btn">Read More</a>
                            <div class="real-world__icon-box">
                ...
                <div class="row">
                    <div class="col-xl-5 col-lg-6">
                        <div class="reasons__left">
                            <h2 class="reasons__title">Uncompromising on Funds Safety.</h2>
                            <ul class="list-unstyled reasons__list-box">
                                <li>
                                    ...
                                    <div class="reasons__content">
                                        <h4 class="reasons__content-title">Negative Balance Protection</h4>
                                        <p class="reasons__content-text">We protect all of our clients from a negative account balance</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="reasons__icon">
                                    ...
                                    <div class="reasons__content">
                                        <h4 class="reasons__content-title">Segregated
                                            Аccounts</h4>
                                        <p class="reasons__content-text">Client funds are stored in a segregated account for maximum safety</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="reasons__icon">
                                    ...
                                    <div class="reasons__content">
                                        <h4 class="reasons__content-title">Secure
                                            Infrastructure</h4>
                                        <p class="reasons__content-text">We utilise the most advanced technology for maximum security of trading accounts</p>
                                    </div>
                                </li>
                            </ul>
                        </div>
